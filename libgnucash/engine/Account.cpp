...
static gpointer
is_opening_balance_account (const Account* account, gpointer data)
{
...
Account*
gnc_account_lookup_by_opening_balance(const Account* account, const gnc_commodity* commodity)
{
    return gnc_account_foreach_descendant_until(account, is_opening_balance_account, commodity);
}
